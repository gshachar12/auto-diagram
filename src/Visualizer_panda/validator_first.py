...
def run_llm_agent_validation(diagram_code: str, entities_json_str: str, steps_json_str: str, model: str, api_key: str) -> str:
    """
    ...
    if model == "gpt-5":
        ...
        return validate_diagram_openai(messages=[validator_prompt, diagram_code, entities_json_str, steps_json_str], api_key=api_key, model=model)
    else:
        print("Validate with Gemini")
        return validate_diagram_gemini(messages=[validator_prompt, diagram_code, entities_json_str, steps_json_str], api_key=api_key, model=model)
...
def full_validator(diagram_code: str, entities_json_str: str, steps_json_str: str, api_key: str, model: str) -> Dict:
    ...
    llm_feedback = run_llm_agent_validation(xml_corrected_diagram, entities_json_str, steps_json_str,model, api_key)
